...
ALTER TABLE PbUser
	...
	CHECK (userFirstName = 'A-z');
ALTER TABLE PbUser
	ADD CONSTRAINT CK_PbUser_userLastName
	CHECK (userLastName = 'A-z');
	
ALTER TABLE PbUser
	ADD CONSTRAINT CK_PbUser_UserID
	CHECK (UserID = 'PB[0-9][0-9][0-9][0-9][0-9][0-9][0-9]');
	
ALTER TABLE PbUser
	ADD CONSTRAINT CK_PbUser_userPhoneNumber
	CHECK (userPhoneNumber = '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]');
